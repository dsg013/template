...
const TermsAndConditions = () => {
    return (
        <div className="terms-and-conditions">
            <div className="terms-and-conditions-header-container">
                <h1 className="terms-and-conditions-header">
                    Terms &amp; Conditions
                </h1>
            </div>
            <div className="terms-and-conditions-content-container">
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        ...
                        <span className="bold-text"> Lorem Ipsum</span> Website,
                        located at
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        ...
                        <span className="bold-text"> Lorem Ipsum</span> if you
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        We employ the use of cookies. By accessing Website Name,
                ...
                <div className="terms-and-conditions-list-container">
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        ...
                        <span className="bold-text"> Lorem Ipsum </span> does
                        ...
                        <span className="bold-text"> Lorem Ipsum </span>,its
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        <span className="bold-text"> Lorem Ipsum </span>{' '}
                        reserves the right to monitor all Comments and to remove
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        You hereby grant{' '}
                        <span className="bold-text"> Lorem Ipsum </span> a
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        ...
                        <span className="bold-text">Lorem Ipsum</span>; and (d)
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        ...
                        <span className="bold-text">Lorem Ipsum</span>. Please
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        No use of{' '}
                        <span className="bold-text">Lorem Ipsum's</span> logo or
                ...
                <div className="terms-and-conditions-content">
                    <p>
                        WTo the maximum extent permitted by applicable law, we
